<x-app-layout>
    <div class="py-8 bg-gray-50">
        <div class="max-w-5xl mx-auto px-6 pb-12">
            ...
            <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                @csrf
                @method('PUT')

                <h2 class="text-xl font-bold text-gray-900 mb-8 pb-4 border-b border-gray-100">Edit Customer: {{ $customer->customer_code }}</h2>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" required value="{{ old('name', $customer->name) }}" placeholder="Enter full name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" required value="{{ old('email', $customer->email) }}" placeholder="Enter email address" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" required value="{{ old('phone', $customer->phone) }}" placeholder="Enter 10-digit mobile number" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        ...
                        <div>
                            ...
                            @if($customer->profile_image)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($customer->profile_image) }}" alt="Current Profile" class="h-16 w-16 rounded-full object-cover">
                                </div>
                            @endif
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="address" required value="{{ old('address', $customer->address) }}" placeholder="Enter full address" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="pincode" required value="{{ old('pincode', $customer->pincode) }}" placeholder="Enter pincode" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" placeholder="Leave blank to keep current" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" placeholder="Confirm new password" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                        </div>
                    </div>
                </div>
