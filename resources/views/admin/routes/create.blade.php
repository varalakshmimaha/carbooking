    ...
    <div class="py-12 bg-gray-50" x-data="routeGenerator()">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Create Route</h1>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <form action="{{ route('admin.routes.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                    @csrf
                    ...
                    <div class="mb-10 bg-blue-50 border border-blue-100 p-6 rounded-2xl flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 class="font-bold text-blue-900">Magic Generate</h3>
                                <p class="text-sm text-blue-700">Auto-fill SEO content based on From & To cities.</p>
                            </div>
                        </div>
                        <button type="button" @click="generateAI()" :disabled="loading" class="bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-200 flex items-center">
                            ...
                            <span x-text="loading ? 'Generating...' : 'Auto Generate Content'"></span>
                        </button>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="title" x-model="title" required class="w-full border-gray-200 rounded-xl focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. Bangalore to Mysore Cab Service">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Slug <span class="text-red-500">*</span></label>
                                <input type="text" name="slug" x-model="slug" required class="w-full border-gray-200 rounded-xl focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. bangalore-to-mysore-cab-service">
                            </div>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Image Alt Title <span class="text-red-500">*</span></label>
                            <input type="text" name="image_title" x-model="image_title" required class="w-full border-gray-200 rounded-xl focus:ring-blue-500 focus:border-blue-500" placeholder="e.g. Bangalore to Mysore Taxi Service">
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Route Description <span class="text-red-500">*</span></label>
                            <textarea name="description" x-model="description" rows="8" required class="w-full border-gray-200 rounded-xl focus:ring-blue-500 focus:border-blue-500" placeholder="Enter detailed route description..."></textarea>
                        </div>
                    ...
                    <div class="mt-12 flex justify-end space-x-4 border-t border-gray-50 pt-8">
                        ...
                        <button type="submit" class="px-12 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 shadow-xl shadow-blue-200 transition-all">CREATE ROUTE</button>
                    </div>
                </form>
            </div>
        </div>
